...
export default function NavbarEco() {
    const [totalProduct, setTotalProduct] = useState(0)
    const [globalData, setGlobalData] = useState(ContextData)
    
    useEffect(() => {
        console.log("Run Cart Data", globalData)
        if (globalData.addedProducts) {
            // setTotalProduct(globalData.addedProducts.length || 0)
        }
    }, [globalData])

    return (
        <div><header className="p-4 dark:bg-gray-800 dark:text-gray-100">
            <div className="container flex justify-between h-16 mx-auto">
                ...
                <ul className="items-stretch hidden space-x-3 md:flex">
                    ...
                    <li className="flex">
                        <a rel="noopener noreferrer" href="/#" className="flex items-center px-4 -mb-1 border-b-2 dark:border-transparent dark:text-violet-400 dark:border-violet-400">Cart</a>
                    </li>
                    <li className="flex">
